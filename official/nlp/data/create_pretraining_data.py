  ...
  while i < len(document):
    ...
    if i == len(document) - 1 or current_length >= target_seq_length:
      if current_chunk:
        ...
        # print('length_current_chunk:', len(current_chunk))
        # print('tokens_a:',tokens_a)
        # print('length_tokens_a:', len(tokens_a))
        tokens_b = []
        # Random next
        ...
        # print('tokens_b_befortrunc:', tokens_b)
        truncate_seq_pair(tokens_a, tokens_b, max_num_tokens, rng)

        # print('tokens_b:',tokens_b)
        # print('length_tokens_b:', len(tokens_b))
        # print('---'*100)
...
def truncate_seq_pair(tokens_a, tokens_b, max_num_tokens, rng):
  ...
  while True:
    ...
    if rng.random() < 0.5:
      ...
      trunc_tokens.pop()
    # print('trunc_tokens:',trunc_tokens)
