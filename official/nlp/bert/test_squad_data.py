...
input_file_path = r'E:\BERT_TEST\bert_test2_code\bert_test\models-master\official\nlp\bert\train_squad.json'
...
train_writer = FeatureWriter(
        filename=os.path.join(r'E:\BERT_TEST\bert_test2_code\bert_test\models-master\official\nlp\bert\output_dir', "train.tf_record"),
        is_training=True)

def main(_):
  tokenizer = tokenization.FullTokenizer(
    vocab_file=FLAGS.vocab_file, do_lower_case=True)
  examples = read_squad_examples(input_file_path, True)
  ...
  #
  # for (example_index, example1) in enumerate(examples):
  #   # print(example1)
  #   print('--'* 100)
  #   print(example_index)
  #   print(example1.qas_id)
  #   print(example1.question_text )
  #   print(example1.doc_tokens )
  #   print(example1.orig_answer_text)
  #   print(example1.start_position  )
  #   print(example1.end_position )
  #   print(example1.is_impossible )
  #   print('==' * 100)
